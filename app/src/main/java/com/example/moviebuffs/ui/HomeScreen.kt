...
fun HomeScreen(
    ...
    when (movieUiState) {
        ...
        is MovieUiState.Success -> PhotosGridScreen(movieUiState.photos, modifier)
...
@Composable
fun PhotosGridScreen(photos: List<MoviePhoto>, modifier: Modifier = Modifier) {
    LazyVerticalGrid(
...
@Preview
@Composable
fun MoviePhotoCardPreview() {
    MovieBuffsTheme {
        val mockData = MoviePhoto("", "")
        MoviePhotoCard(mockData)
    }
}
